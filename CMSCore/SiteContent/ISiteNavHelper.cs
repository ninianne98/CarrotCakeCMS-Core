...
namespace Carrotware.CMS.Core {
	...
	public interface ISiteNavHelper : IDisposable {
		...
		SiteNav FindContentByID(Guid siteID, bool bActiveOnly, Guid rootContentID);
		...
		List<SiteNav> PerformDataPagingQueryableContent(Guid siteID, bool bActiveOnly, int pageSize, int pageNumber, string sortField, string sortDir, IQueryable<vwCarrotContent> QueryInput);
	}
}