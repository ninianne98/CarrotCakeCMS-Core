	...
	public class jquery : BaseWebComponent {
		...
		public override string GetHtml() {
			...
			switch (jqVer) {
				...
				case "2.2":
					jqVer = "2.2.4";
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquery.jquery-2-2-4.js");
					break;
				...
				case "1.12":
					jqVer = "1.12.4";
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquery.jquery-1-12-4.js");
					break;
			...
			if (this.UseJqueryMigrate) {
				...
				if (jqVer.StartsWith("1.9") || jqVer.StartsWith("1.10") || jqVer.StartsWith("1.11")) {
					sJQFileMig = CarrotWebHelper.GetWebResourceUrl("jquery.jquery-mig-1-2-1.js");
				}
