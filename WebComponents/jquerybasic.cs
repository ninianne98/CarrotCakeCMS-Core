		...
		public override string GetHtml() {
			...
			switch (this.SelectedSkin) {
				case jQueryTheme.GlossyBlack:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-black.css");
					break;

				case jQueryTheme.Purple:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-purple.css");
					break;

				case jQueryTheme.Green:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-green.css");
					break;

				case jQueryTheme.Blue:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-blue.css");
					break;

				case jQueryTheme.LightGreen:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-lightgreen.css");
					break;

				case jQueryTheme.Silver:
				default:
					sJQFile = CarrotWebHelper.GetWebResourceUrl("jquerybasic.jquery-ui-silver.css");
					break;
			}
