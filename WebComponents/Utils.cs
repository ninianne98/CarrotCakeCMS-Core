...
namespace Carrotware.Web.UI.Components {
	...
	public static class Utils {
		...
		public static string GetRouteValue(this IDictionary<string, object> routeValues, string key) {
			if (routeValues.TryGetValue(key, out var keyValue) && keyValue is not null) {
		...
		public static RouteValueDictionary AddUpdateRouting(this RouteValueDictionary routeData, string key, string? value) {
			string keyLower = key.ToLowerInvariant();
			if (routeData.ContainsKey(keyLower)) {
				routeData[keyLower] = value;
			} else {
				routeData.Add(keyLower, value);
			}

			return routeData;
		}

		public static RouteValueDictionary SetRouteValues(this RouteValueDictionary routeData, string? areaValue, string controllerValue, string actionValue, string? idValue) {
		...
		public static RouteValueDictionary SetRouteValues(this RouteValueDictionary routeData, string controllerValue, string actionValue, string? idValue) {
			return routeData.SetRouteValues(null, controllerValue, actionValue, idValue);
		}

		public static RouteValueDictionary SetRouteValues(this RouteValueDictionary routeData, string controllerValue, string actionValue) {
		...
		public static ViewContext SetContextRoutevalues(this ViewContext requestCtx, string? areaValue, string? controllerValue, string? actionValue, string? idValue) {
		...
		public static ViewContext SetContextRoutevalues(this ViewContext requestCtx, string? controllerValue, string? actionValue, string? idValue) {
			return requestCtx.SetContextRoutevalues(null, controllerValue, actionValue, idValue);
		}

		public static ViewContext SetContextRoutevalues(this ViewContext requestCtx, string? controllerValue, string? actionValue) {
			return requestCtx.SetContextRoutevalues(null, controllerValue, actionValue, null);
		}

		public static ViewContext SetContextRoutevalues(this ViewContext requestCtx, Dictionary<string, string?> dictValues) {
