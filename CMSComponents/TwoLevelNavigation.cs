...
namespace Carrotware.CMS.UI.Components {
	...
	public class TwoLevelNavigation : BaseTwoPartCmsComponent, IWidgetLimitedProperties {
		...
		public TwoLevelNavigation(string f, string bg, string ubg, string fc, string bc,
			...
			this.BGColor = CarrotWebHelper.DecodeColor(bg);
			this.UnSelBGColor = CarrotWebHelper.DecodeColor(ubg);
			this.ForeColor = CarrotWebHelper.DecodeColor(fc);
			this.BackColor = CarrotWebHelper.DecodeColor(bc);

			this.HoverBGColor = CarrotWebHelper.DecodeColor(hbc);
			this.HoverFGColor = CarrotWebHelper.DecodeColor(hfc);

			this.UnSelFGColor = CarrotWebHelper.DecodeColor(uf);
			this.SelBGColor = CarrotWebHelper.DecodeColor(sbg);
			this.SelFGColor = CarrotWebHelper.DecodeColor(sfg);

			this.SubBGColor = CarrotWebHelper.DecodeColor(bc2);
			this.SubFGColor = CarrotWebHelper.DecodeColor(fc2);
		}

		public TwoLevelNavigation(string f, string mainColor) : this() {
			var main = CarrotWebHelper.DecodeColor(mainColor);
		...
		public override string GetHead() {
			...
			if (!this.AutoStylingDisabled) {
				...
				sb.Append(string.Format("&bg={0}&ubg={1}&fc={2}&bc={3}", CarrotWebHelper.EncodeColor(this.BGColor), CarrotWebHelper.EncodeColor(this.UnSelBGColor), CarrotWebHelper.EncodeColor(this.ForeColor), CarrotWebHelper.EncodeColor(this.BackColor)));
				sb.Append(string.Format("&hbc={0}&hfc={1}", CarrotWebHelper.EncodeColor(this.HoverBGColor), CarrotWebHelper.EncodeColor(this.HoverFGColor)));
				sb.Append(string.Format("&uf={0}&sbg={1}&sfg={2}", CarrotWebHelper.EncodeColor(this.UnSelFGColor), CarrotWebHelper.EncodeColor(this.SelBGColor), CarrotWebHelper.EncodeColor(this.SelFGColor)));
				sb.Append(string.Format("&bc2={0}&fc2={1}", CarrotWebHelper.EncodeColor(this.SubBGColor), CarrotWebHelper.EncodeColor(this.SubFGColor)));
