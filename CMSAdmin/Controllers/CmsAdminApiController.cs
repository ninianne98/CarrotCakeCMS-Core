	...
	public class CmsAdminApiController : Controller {
		...
		public string GenerateNewFilename(string ThePageTitle, string GoLiveDate, string PageID, string Mode) {
			try {
				...
				return JsonSerializer.Serialize(SiteData.GenerateNewFilename(_currentPageGuid, sThePageTitle, goLiveDate, pageType));
			} catch (Exception ex) {
		...
		public string ValidateUniqueFilename(string TheFileName, string PageID) {
			try {
				...
				return JsonSerializer.Serialize(IsUniqueFilename(TheFileName, _currentPageGuid));
			} catch (Exception ex) {
		...
		public string ValidateUniqueBlogFilename(string ThePageSlug, string GoLiveDate, string PageID) {
			try {
				...
				return JsonSerializer.Serialize(IsUniqueBlogFilename(ThePageSlug, dateGoLive, _currentPageGuid));
			} catch (Exception ex) {
