...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carrotware.CMS.Data.Models.MembershipRole", b =>
                {
            ...
            modelBuilder.Entity("Carrotware.CMS.Data.Models.MembershipUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("MembershipUserRole", b =>
                {
                    ...
                    b.HasKey("UserId", "RoleId")
                        .HasName("PK_dbo.membership_UserRole");

                    b.HasIndex(new[] { "RoleId" }, "IX_RoleId");

                    b.HasIndex(new[] { "UserId" }, "IX_UserId");

                    b.ToTable("membership_UserRole", (string)null);
                });
            ...
            modelBuilder.Entity("Carrotware.CMS.Data.Models.CarrotUserData", b =>
                {
                    b.HasOne("Carrotware.CMS.Data.Models.MembershipUser", "UserKeyNavigation")
                        .WithMany("CarrotUserData")
                        .HasForeignKey("UserKey")
                        .HasConstraintName("carrot_UserData_UserKey");
            ...
            modelBuilder.Entity("MembershipUserRole", b =>
                {
                    b.HasOne("Carrotware.CMS.Data.Models.MembershipRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_dbo.membership_UserRole_dbo.membership_Role_RoleId");

                    b.HasOne("Carrotware.CMS.Data.Models.MembershipUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_dbo.membership_UserRole_dbo.membership_User_UserId");
                });
