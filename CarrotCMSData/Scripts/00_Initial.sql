...
IF exists(SELECT top 1 * 
	...
	WHERE TABLE_NAME ='vw_carrot_TrackbackQueue') BEGIN
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[carrot_TrackbackQueue]') AND type in (N'U'))
	DROP TABLE [dbo].[carrot_TrackbackQueue]
GO
