...
namespace Northwind.Data {
	...
	Scaffold-DbContext "Server=.\SQL2016EXPRESS;Database=Northwind;Trusted_Connection=True;Encrypt=False;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir  Data\Northwind
	...
	dotnet ef dbcontext scaffold "Server=.\SQL2016EXPRESS;Database=Northwind;Trusted_Connection=True;Encrypt=False;" Microsoft.EntityFrameworkCore.SqlServer -o Data\Northwind
	*/
	...
	public partial class NorthwindContext : DbContext {
		...
		//	var conn = _configuration.GetConnectionString("NorthwindConnection");
		...
		public static NorthwindContext Create() {
			...
			DataHelper.Configure("NorthwindConnection", optionsBuilder);
